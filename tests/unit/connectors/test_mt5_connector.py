...
class TestMT5Connector:
    ...
    @patch("trading_worker.connectors.mt5_connector.mt5", new=MockMT5())
...
class TestMT5ConnectorAdvanced:
    ...
    @patch("trading_worker.connectors.mt5_connector.mt5")
    @patch("trading_worker.connectors.mt5_connector.time.sleep")
    ...
    def test_terminal_not_running_error(self, mock_mt5):
        ...
        from trading_worker.exceptions import MT5TerminalNotRunningError
    ...
    def test_version_incompatible_error(self, mock_mt5):
        ...
        from trading_worker.exceptions import MT5VersionIncompatibleError
    ...
    def test_is_connected_checks_terminal(self):
        ...
        with patch("trading_worker.connectors.mt5_connector.mt5", new=mock_mt5):
...
class TestMT5ConnectorMissingCoverage:
    ...
    @patch("trading_worker.connectors.mt5_connector.MT5_AVAILABLE", False)
    ...
    @patch("trading_worker.connectors.mt5_connector.mt5.version")
