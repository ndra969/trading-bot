...
async def test_support_trendline_detection(analyzer):
    ...
    prices[10] = 100.0
    prices[9] = 105.0; prices[11] = 105.0 # Ensure it's a valley
    
    # Swing 2: Index 30, Price 104 (100 + 0.2 * 20)
    prices[30] = 104.0
    prices[29] = 109.0; prices[31] = 109.0
    
    # Swing 3: Index 50, Price 108 (100 + 0.2 * 40)
    prices[50] = 108.0
    prices[49] = 113.0; prices[51] = 113.0
    ...
    support_lines = [l for l in signal.trendlines if l.line_type == 'SUPPORT']
...
async def test_resistance_trendline_detection(analyzer):
    ...
    prices[10] = 120.0
    prices[9] = 115.0; prices[11] = 115.0
    
    # Swing 2: Index 30, Price 116 (Down 4)
    prices[30] = 116.0
    prices[29] = 111.0; prices[31] = 111.0
    
    # Swing 3: Index 50, Price 112 (Down 4)
    prices[50] = 112.0
    prices[49] = 107.0; prices[51] = 107.0
    ...
    resistance_lines = [l for l in signal.trendlines if l.line_type == 'RESISTANCE']
...
async def test_invalid_line_cutting_price(analyzer):
    ...
    # Swing 1: Index 10, Price 100
    prices[10] = 100.0
    prices[9] = 105.0; prices[11] = 105.0
    
    # Swing 2: Index 50, Price 100
    prices[50] = 100.0
    prices[49] = 105.0; prices[51] = 105.0
    ...
    prices[70] = 100.0
    prices[69] = 105.0; prices[71] = 105.0
