...
class TestRobustIndicatorCalculator:
    ...
    def test_fallback_chain(self, sample_data):
        ...
        with patch('src.trading_bot.strategies.enhancement.technical_analyzer.TALibHighPerformance') as mock_talib, \
             patch('src.trading_bot.strategies.enhancement.technical_analyzer.TechnicalIndicatorCalculator') as mock_pandas_ta:
