...
class DryRunMT5Wrapper:
    ...
    def modify_position(
        ...
        **kwargs: Any,
        ...
        logger.info(f"[DRY-RUN] Simulated modify: ticket {ticket} SL={sl} TP={tp}")
        return {
            "success": True,
            "modified": True,
    ...
    def close_position(
        ...
        **kwargs: Any,
        ...
        self._simulated_closes.append({"ticket": ticket, "volume": volume, "comment": comment})
        logger.info(f"[DRY-RUN] Simulated close: ticket {ticket} volume={volume}")
        return {
            "success": True,
            "ticket": ticket,
            "volume": volume,
    ...
    def get_positions(self, symbol: str | None = None) -> list[dict[str, Any]]:
        ...
        """
        return (
            self.connector.get_positions(symbol=symbol)
            if symbol
            else self.connector.get_positions()
        )
